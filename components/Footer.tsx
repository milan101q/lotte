    ...
    <footer id="contact" className="bg-stone-900 text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="space-y-12">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a 
                      ...
                      className="inline-flex items-center px-6 py-2 bg-stone-100 hover:bg-stone-200 text-stone-900 font-bold tracking-widest text-xs uppercase transition-all rounded-sm"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center px-6 py-2 border border-amber-800 text-amber-500 hover:bg-amber-800 hover:text-white font-bold tracking-widest text-xs uppercase transition-all rounded-sm"
                    >
                      Leave a Review
                    </a>
                  </div>
              ...
              <div className="flex items-start space-x-4 pt-4 border-t border-stone-800">
                <div className="w-full">
                  <h4 className="font-bold uppercase tracking-widest text-xs text-stone-400 mb-6 text-center sm:text-left">Facilities & Accessibility</h4>
               ...
               <div className="bg-white text-stone-900 p-8 shadow-2xl rounded-sm max-w-sm border-t-4 border-amber-800">
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex justify-between border-b border-stone-100 pb-2">
                      ...
                      <span className="text-stone-900 font-medium">{BUSINESS_INFO.hours.weekday}</span>
                    </div>
                    <div className="flex justify-between border-b border-stone-100 pb-2">
                      <span className="text-stone-500 uppercase text-xs font-bold tracking-widest">Sat — Sun</span>
                      <span className="text-stone-900 font-medium">{BUSINESS_INFO.hours.weekend}</span>
                    </div>
                  </div>
                  <div className="flex flex-col space-y-3">
                    <a href={`tel:${BUSINESS_INFO.phone.replace(/\D/g, '')}`} className="block w-full py-4 bg-stone-900 text-white text-center font-bold tracking-widest uppercase hover:bg-stone-700 transition-all shadow-lg text-xs">
                      Call for Availability
                    </a>
                    <a href={BUSINESS_INFO.reviewUrl} target="_blank" rel="noopener noreferrer" className="block w-full py-3 border border-amber-800 text-amber-800 text-center font-bold tracking-widest uppercase hover:bg-amber-800 hover:text-white transition-all text-[10px]">
        ...
        <div className="pt-12 border-t border-stone-800 flex flex-col md:flex-row justify-between items-center text-sm text-stone-500">
          <p>© {new Date().getFullYear()} Lotte Plaza Barber & Salon. High Fidelity Grooming.</p>
        </div>
      </div>
    </footer>
  );
